...
<html class="no-js">
	...
	<title>Welcome Ngetravel Indonesia</title>
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">Ngetravel</a></h1>
				<nav role="navigation">
					<ul>
						<li class="active"><a href="<?php echo base_url().''?>">Home</a></li>
						<li><a href="<?php echo base_url().'about'?>">Tentang Kami</a></li>
						<li><a href="<?php echo base_url().'portfolio'?>">Daftar Harga</a></li>
						...
						<li class="cta"><a href="<?php echo base_url().'portfolio'?>">Mulai</a></li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<div id="fh5co-why-us" class="animate-box">
		<div class="container">
			...
			<!-- <div class="text-center">Mengapa Kami</div> -->
				...
				<div class="col-md-4 text-center item-block">
					...
					<p>Ngetravel memberikan Jaminan layanan perencanaan dan pemesanan produk perjalanan yang mudah, murah, dan aman didukung dengan konfirmasi singkat dan proses yang akurat.</p>
					<p><a href="<?php echo base_url().'portfolio'?>" class="btn btn-primary btn-outline with-arrow">Mulai<i class="icon-arrow-right"></i></a></p>
				</div>
				<div class="col-md-4 text-center item-block">
					<span class="icon"><img src="<?php echo base_url().'theme/images/18.svg'?>" class="img-responsive"></span>
					<h3>Tepat Waktu</h3>
					<p>Jadwal acara/pesawat Anda terlambat? Ngetravel memiliki jadwal keberangkatan yang Banyak sehingga bisa disesuaikan dengan Jadwal Acara/Pesawat Anda.</p>
					<p><a href="<?php echo base_url().'portfolio'?>" class="btn btn-primary btn-outline with-arrow">Mulai <i class="icon-arrow-right"></i></a></p>
				</div>
				<div class="col-md-4 text-center item-block">
					<span class="icon"><img src="<?php echo base_url().'theme/images/27.svg'?>" class="img-responsive"></span>
					<h3>Hemat, Mudah & Cepat</h3>
					<p>Sudah pesan travel tapi waktu keberangkatan masih diminta biaya tol, bagasi dll? Ngetravel hanya menawarkan perjalanan berkualitas yang hemat dengan Harga Final! </p>
					<p><a href="<?php echo base_url().'portfolio'?>" class="btn btn-primary btn-outline with-arrow">Mulai <i class="icon-arrow-right"></i></a></p>
				</div>
			</div>
		</div>
